...
export const SignupPage: React.FC = () => {
  ...
  return (
    <AuthGlassLayout maxWidth="max-w-xl">
      <div className="animate-fade-in flex flex-col justify-center py-4">
                    ...
                    <button
                      ...
                      className={`p-3 rounded-xl border text-left transition-all cursor-pointer flex items-start gap-2.5 ${
                        budgetStyle === opt.id
                          ...
                          : 'bg-white/70 border-slate-200 hover:border-slate-300 backdrop-blur-sm'
                      }`}
                    >
