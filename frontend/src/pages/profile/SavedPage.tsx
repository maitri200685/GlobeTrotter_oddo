...
const MOCK_SAVED_DESTINATIONS: SavedDestination[] = [
  ...
  },
  {
    ...
    description: 'Sacred Ganges ghats, mesmerizing aarti ceremonies, ancient temples, and spiritual immersion.',
    rating: 4.9,
    avgDailyCost: '₹2,800',
    bestSeason: 'Oct – Mar',
    savedAt: '2026-08-08',
    tags: ['Spiritual', 'Heritage', 'Ghats', 'Culture'],
  },
  {
    id: 'dest-andaman',
    cityName: 'Andaman',
    ...
    description: 'Pristine turquoise lagoons, coral reef scuba diving, bioluminescent beaches, and island hopping.',
    rating: 4.8,
    avgDailyCost: '₹5,500',
    bestSeason: 'Nov – Apr',
    savedAt: '2026-08-05',
    tags: ['Beach', 'Scuba', 'Islands', 'Nature'],
  },
  {
    id: 'dest-rishikesh',
    cityName: 'Rishikesh',
    ...
    description: 'Yoga capital of the world, Ganga river rafting, spiritual ashrams, and Himalayan foothills.',
    rating: 4.7,
    avgDailyCost: '₹2,200',
    bestSeason: 'Sep – Jun',
    savedAt: '2026-07-28',
    tags: ['Adventure', 'Yoga', 'Spiritual', 'Rafting'],
  },
];
