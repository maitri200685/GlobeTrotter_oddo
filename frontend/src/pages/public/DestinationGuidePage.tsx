...
const DESTINATIONS_DB: Record<string, {
  ...
  'dest-varanasi': {
    ...
    gallery: [
      ...
      'https://images.unsplash.com/photo-1542147185-a6c3b2a584bd?w=600&q=80',
      'https://images.unsplash.com/photo-1517443792736-2ee0bf50008a?w=600&q=80',
    ],
    tagline: 'India\'s Spiritual Heart on the Ganges',
    description: 'Varanasi is one of the oldest continuously inhabited cities in the world, India\'s spiritual capital on the sacred Ganges. Famous for its 88 ghats, mesmerizing Ganga Aarti ceremonies, ancient temples, and classical music traditions — Varanasi is the soul of India.',
    rating: 5.0,
    reviews: 28000,
    avgDailyCost: '₹1,800 – ₹3,500',
    bestMonths: ['Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar'],
    climate: 'Subtropical • Cool winters, warm summers, monsoon Jul-Sep',
    currency: 'Indian Rupee (₹)',
    language: 'Hindi, Bhojpuri (English understood in tourist areas)',
    timezone: 'IST (UTC+5:30)',
    tags: ['Spiritual', 'Heritage', 'Food', 'Photography', 'Culture'],
    topActivities: [
      { title: 'Dashashwamedh Ghat Ganga Aarti', type: 'Culture', duration: '1.5 hours', cost: 'Free', image: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=400&q=80' },
      { title: 'Sunrise Boat Ride on Ganges', type: 'Sightseeing', duration: '2 hours', cost: '₹500', image: 'https://images.unsplash.com/photo-1542147185-a6c3b2a584bd?w=400&q=80' },
      { title: 'Sarnath Buddhist Pilgrimage', type: 'Spiritual', duration: '3 hours', cost: '₹20', image: 'https://images.unsplash.com/photo-1517443792736-2ee0bf50008a?w=400&q=80' },
      { title: 'Kashi Vishwanath Temple Darshan', type: 'Spiritual', duration: '2 hours', cost: 'Free', image: 'https://images.unsplash.com/photo-1580418827493-f2767dbcd8e3?w=400&q=80' },
    ],
    topHotels: [
      { name: 'BrijRama Palace Heritage', stars: 5, price: '₹18,500/night', location: 'Assi Ghat Riverside' },
      { name: 'Taj Nadesar Palace', stars: 4, price: '₹9,800/night', location: 'Nadesar Palace Grounds' },
      { name: 'Zostel Varanasi Hostel', stars: 3, price: '₹850/night', location: 'Dashashwamedh Ghat' },
    ],
    neighborhoods: [
      { name: 'Dashashwamedh Ghat', vibe: '🕉️ Sacred Ceremonies', desc: 'The main ghat where the world-famous Ganga Aarti takes place every evening with 7 priests.' },
      { name: 'Assi Ghat', vibe: '🌅 Boho & Cafes', desc: 'Popular for sunrise boat rides, riverside cafes, and classical music performances.' },
      { name: 'Godowlia Market', vibe: '🍛 Street Food Hub', desc: 'Bustling old city market with Banarasi paan, kachori sabzi, lassi, and silk saree shops.' },
    ],
    travelTips: [
      'Book a sunrise boat ride (5-7 AM) for the most magical Ganga ghat views.',
      'Try the famous Kashi Chat Bhandar tamatar chaat and Blue Lassi for authentic flavors.',
      'Respect local customs: cover shoulders/knees at temples, sit quietly during aarti.',
      'Take an auto-rickshaw instead of a taxi in the old city — the lanes are narrow.' ],
