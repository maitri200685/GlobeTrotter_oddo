...
const SEED_ACTIVITIES: Activity[] = [
  ...
  {
    id: 'act-varanasi-1',
    title: 'Dashashwamedh Ghat Ganga Aarti Experience',
    cityName: 'Varanasi',
    country: 'India',
    category: 'culture',
    duration: '1.5 hours',
    ...
    description: 'Witness the mesmerizing evening Ganga Aarti ceremony with 7 saffron-robed priests performing synchronized sacred rituals to the Ganges river.',
    recommendedTimeSlot: 'evening',
    suggestedTime: '18:30',
    location: 'Dashashwamedh Ghat, Varanasi',
    tags: ['Ganga Aarti', 'Sacred Ritual', 'Spiritual'],
    highlights: ['Synchronized fire lamps', 'Conch shell sounds', 'Spiritual atmosphere'],
  },

  // UDAIPUR ACTIVITIES
  {
    id: 'act-udaipur-1',
    title: 'Lake Pichola Sunset Boat Cruise & Palace Views',
    cityName: 'Udaipur',
    country: 'India',
    ...
    description: 'Boat cruise on shimmering Lake Pichola passing the iconic Lake Palace, Jag Mandir, and the majestic City Palace at golden sunset hour.',
    recommendedTimeSlot: 'evening',
    suggestedTime: '17:30',
    location: 'Ambrai Ghat, Udaipur',
    tags: ['Boat Cruise', 'Lake Palace', 'Sunset Views'],
    highlights: ['Taj Lake Palace photo spot', 'Sunlit palaces', 'Live folk music option'],
  },
];
