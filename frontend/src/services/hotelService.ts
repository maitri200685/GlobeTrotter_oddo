...
const SEED_HOTELS: Hotel[] = [
  ...
  {
    id: 'htl-kyoto-1',
    name: 'Kyoto Machiya Traditional Ryokan',
    cityName: 'Kyoto',
    country: 'Japan',
    starRating: 4,
    userRating: 4.9,
    ...
    gallery: ['https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?auto=format&fit=crop&w=600&h=400&q=80'],
    address: 'Gion District, Kyoto',
    amenities: ['Free Breakfast', 'WiFi', 'Air Conditioning', 'Spa'],
    aiMatchScore: 98,
    whyAiRecommends: '98% Match: Authentic tatami-mat suites and onsen bath in the historic Gion geisha quarter.',
  ...
  // PARIS HOTELS
  {
    ...
    gallery: ['https://images.unsplash.com/photo-1502602898657-3e91760cbb34?auto=format&fit=crop&w=600&h=400&q=80'],
    address: '4th Arrondissement, Paris',
    amenities: ['WiFi', 'Free Breakfast', 'Air Conditioning', 'Bar'],
    aiMatchScore: 97,
    whyAiRecommends: '97% Match: Charming Parisian boutique stay steps away from art galleries, bakeries, and cafes.',
    coordinates: { lat: 48.8575, lng: 2.3580 },
  },
];
