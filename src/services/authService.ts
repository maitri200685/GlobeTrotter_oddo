...
const SEED_PERSONAS: DemoPersona[] = [
  {
    ...
    user: {
      ...
      avatarUrl: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=200&h=200&q=80',
      bio: 'Backpacker, photographer, and chai enthusiast exploring off-beat trails across India and Southeast Asia.',
      role: 'user',
      preferences: {
      ...
      savedDestinations: ['Goa', 'Manali', 'Kyoto', 'Hampi', 'Bali'],
  ...
  },
  {
    ...
    user: {
      ...
      savedDestinations: ['Goa', 'Udaipur', 'Kerala', 'Paris', 'Santorini'],
  ...
  },
  {
    ...
    tagline: 'Global Cultural Explorer • Luxury',
    avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&h=200&q=80',
    user: {
      id: 'usr-elena-103',
      name: 'Elena Rostova',
      email: 'elena.rostova@globetrotter.org',
      avatarUrl: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=200&h=200&q=80',
      bio: 'Architect and art historian planning immersive cultural journeys, Michelin dining, and luxury heritage hotels.',
      role: 'user',
      preferences: {
        budgetStyle: 'luxury',
        travelPace: 'packed',
        ...
        dietary: 'gluten-free',
        favoriteInterests: ['Architecture', 'Art Museums', 'Wine Tasting', 'Historical Forts', 'Michelin Dining'],
        homeAirportOrCity: 'London (LHR)',
        emailNotifications: true,
        tripAlerts: true,
        marketingEmails: false,
      },
      stats: {
        ...
        citiesVisited: 28,
        countriesExplored: 8,
        savedBudgetTotal: '$5,200',
      },
      savedDestinations: ['Kyoto', 'Paris', 'Jaipur', 'Rome', 'Barcelona', 'Tokyo'],
